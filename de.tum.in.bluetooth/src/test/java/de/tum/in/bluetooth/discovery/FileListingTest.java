...
public class FileListingTest {
	...
	private static final String LIST_HEAD = "<!DOCTYPE folder-listing SYSTEM \"OBEX-folder-listing.dtd\"><folder-listing><parent-folder/>";

	private static final String LIST_TAIL = "</folder-listing>";

	// @Test
	// public void testRealWorldFileListing() throws FileNotFoundException,
	// SAXException, IOException, ParserConfigurationException {
	// File listing = new File("src/test/resources/filelisting.xml");
	// List<ObexFileDescriptor> list = ObexServiceImpl.createFileDescriptors(new
	// FileInputStream(listing));
	//
	...
	// }
	//
	// private static List<ObexFileDescriptor> createListing(final String body)
	// throws Exception {
	// final StringBuilder buf = new StringBuilder();
	// buf.append(LIST_HEAD).append(body).append(LIST_TAIL);
	// return ObexServiceImpl.createFileDescriptors(new
	...
	// assertThat(file.modified.getTimeZone(),
	// equalTo(TimeZone.getTimeZone("GMT")));
